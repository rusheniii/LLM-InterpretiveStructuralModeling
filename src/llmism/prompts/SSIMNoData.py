...
Using your general domain knowledge, established theories, widely accepted causal mechanisms, and common real-world patterns, determine the contextual relationship between the provided factor and every factor in the factors list.

Each factor in the factors list must have exactly one corresponding entry in the output.
...
* Use <provided_factor/> name for the `provided_factor_name` field.
* Use <factor/> name for the `factor_name` field.
